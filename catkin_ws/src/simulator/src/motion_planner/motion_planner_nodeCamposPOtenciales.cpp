        ...
        while( params.run )
        {
            ...
            case 8:
              ...
              /*  {
                ...
                /*
 Intensity es un flotante
 light_readings Arreglo de 8 flotantes
 lidar_readings Sensores (distancias de cada sensor al robot)
 params.laser_num_sensors Numero sensores
 params.laser_value QUIEN SABE PA QUE umbral para el siguiente valor
 q_light QUIEN SABE PAR QUE, en motion_planner_utilities.H quantize_light
q_inputs recibe de Q, sis valores pueden ser 1 (DER), 2 o 3 (IZQ+DER)
movements:
  float twist; Grado de giro con sentido entre -pi y pi
  float advance; Tamaño del paso que dará
                */
                /*DESCOMENTAR ESTA LINEA PARA HACER
                user_sm(intensity,light_readings, lidar_readings, params.laser_num_sensors,params.laser_value,
                        ...
                        params.robot_x, params.robot_y, params.light_x, params.light_y);
                        */
                user_sm(intensity,light_readings, lidar_readings, params.laser_num_sensors,params.laser_value,
                        q_light,q_inputs,&movements,&est_sig ,params.robot_max_advance ,params.robot_turn_angle);
